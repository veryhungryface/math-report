  ...
  return (
    <div ref={ref} className="space-y-3 h-full flex flex-col">
      <div className="flex items-center justify-between mb-1">
        <h4 className="text-sm font-semibold text-navy-200">Top 3 Risk Areas</h4>
        <span className="text-xs text-navy-400">By recurrence rate</span>
      </div>
      ...
      {riskAreas.map((area, i) => {
        ...
        return (
          ...
          >
            ...
            <div>
              <div className="flex items-center justify-between mb-1">
                <span className="text-[10px] text-navy-400">Recurrence</span>
